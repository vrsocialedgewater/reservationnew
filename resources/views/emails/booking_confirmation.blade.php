...
<div class="email-container">
    ...
    <div class="content">
        <p>Dear {{ $name }},</p>
        <p>Thank you for booking with <a href="{{ env('APP_URL') }}">{{ env('APP_NAME') }}</a>! We're excited to confirm your seat.</p>
        ...
        <ul>
            <li>
                <strong>Service:</strong> {{ $service }}  @if($service_package_id)<i>({{ $service_package_name }})</i>@endif <br/>
        ...
        <p>Please arrive 15 minutes early for a brief orientation. If you have any special requests or need to reschedule, don’t hesitate to contact us at <a href="mailto:{{ env("MAIL_CONTACT") }}">{{ env("MAIL_CONTACT") }}</a> or call us at <a class="" title="Call us!" href="tel:+17205248882">&nbsp; +1 (720) 524-8882</a>.</p>
